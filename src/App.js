...
const leaveRoom = (room) => {
  ...
  return (
      ...
      <Container>
        ...
        <Col><h5>Hi {username}! You have joined chat: {currentRoom}.</h5>
        <Button type="reset" onClick={() => leaveRoom(room)}>Leave Room</Button></Col>
        </Row>
        <Row>
          <Col>
          <Stack style={{
      maxHeight: "400px", minHeight: "400px",
      overflowY: "auto", border: "gray solid 0.5px", borderRadius: "4px"}}>
        <h5>JOIN ROOM</h5>
        <Stack>
          {rooms.map((room) => (
